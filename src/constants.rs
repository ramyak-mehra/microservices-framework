pub(crate)const FAILED_TO_SEND_HEARTBEAT: &str = "failedSendHeartbeatPacket";
pub(crate)const FAILED_SEND_PONG_PACKET: &str = "failedSendPongPacket";
pub(crate)const FAILED_SEND_PING_PACKET: &str = "failedSendPingPacket";
